...
abstract class AppTextStyle {
  ...
  static TextStyle titleLarge([Color color = AppColor.neutrals20]) =>
      GoogleFonts.notoSans(
        fontSize: 18,
        fontWeight: FontWeight.bold,
        color: color,
  ...
  /// ChatPage -> 메시지 상태 알림
  /// 닉네임, 취소 버튼,
  static TextStyle bodyLarge([Color color = AppColor.neutrals20]) =>
      GoogleFonts.notoSans(
        fontSize: 16,
  ...
  //! 이용약관에 주로 사용된다
  /// SnsLoginPage -> 이용약관
  static TextStyle bodyMedium([Color color = AppColor.neutrals20]) =>
      GoogleFonts.notoSans(
        fontSize: 14,
  ...
  //! 이용약관에 주로 사용된다
  /// SnsLoginPage -> 이용약관
  static TextStyle bodySmall([Color color = AppColor.neutrals20]) =>
      GoogleFonts.notoSans(
        fontSize: 12,
        fontWeight: FontWeight.w200,
        color: color,
  ...
  static TextStyle labelLarge([Color color = AppColor.neutrals20]) =>
      GoogleFonts.notoSans(
        fontSize: 16,
        fontWeight: FontWeight.bold,
        color: color,
